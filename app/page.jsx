...
export default function HomePage() {
  ...
  const products = [
    ...
    },
    {
      ...
      price: 8.99,
      image: "https://images.unsplash.com/photo-1568702846914-96b305d2aaeb?w=400",
      description: "Classic smooth apple butter - 19 OZ"
    },
    {
      id: 4,
    ...
    },
    {
      ...
      category: "butter",
      price: 9.49,
      image: "https://images.unsplash.com/photo-1628689469838-524a4a973b8e?w=400",
      description: "Sweet Peach Butter - 19 OZ"
    },
    {
      id: 6,
      name: "Strawberry Jam",
        ...
        <div className="hero-content text-center text-white">
          <div className="max-w-3xl">
            <h1 className="text-5xl md:text-6xl font-serif font-bold mb-6 drop-shadow-lg">
              Welcome to Katie Bug's Country Kitchen
            </h1>
            <p className="text-xl md:text-2xl mb-8 font-light">
              Discover our delicious homemade jams, preserves, and more!
            </p>
            <a href="#products" className="btn btn-primary text-white btn-lg">
              Shop Now
            </a>
          </div>
        </div>
      ...
      <section className="bg-accent py-16">
        <div className="container mx-auto px-4 max-w-5xl">
          <h2 className="text-4xl md:text-5xl font-serif font-bold text-center mb-8 text-wood">
            About Katie Bug's Country Kitchen
          </h2>
          <p className="text-lg text-wood/80 mb-6 text-center leading-relaxed">
            ...
            using traditional recipes passed down through generations. Every jar is made
